...
<div class="row">
    <div class="col-md-12">
        <h1 class="page-head-line text-center">All Admin Information</h1>
        <h1 class="page-subhead-line text-center">在此界面，您可以查看所有管理员信息。</h1>
    </div>
</div>
<div class="row">
                            ...
                            <c:if test="${!empty adminList }">  
				                <c:forEach items="${adminList }" var="admin">  
				                    <tr>  
				                        <td>${admin.name }</td>  
				                        <td>${admin.phone}</td>
				                        <td id="sex${admin.account}">${admin.sex }</td>  
				                        <td>${admin.idcardno}</td>
				                        <td>${admin.account}</td>
