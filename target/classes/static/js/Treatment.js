//Ajax提交
function AjaxPost(Url,userInfo,LodingFun,ReturnFun) {
    $.ajax({
        ...
        dataType: "json",
        // beforeSend: function LodingFun("user/registered",userinfo.userName),
...
//弹出
function InfoAlert(e, cb) {
    var index = layer.msg(e, { icon: 1, time: 2000, offset: 't', closeBtn: 0, title: '提示', btn: [], anim: 2, shade: 0 }, cb);
    layer.style(index, {
        color: '#777'
    });
}
