            ...
            <div class="col-md-6 col-sm-6 col-xs-12 col-sm-offset-3">
               <div class="panel panel-info">
                 ...
                 <div class="panel-body">
                     <form role="form" action="/DouyuMMS/member/updateMyInfo" name="memberForm" method="post">
                          <div class="form-group">
                   		  ...
                   		  <div class="form-group">
                              ...
                              <div class="radio">
								  <label>
								    <input type="radio" name="sex" value="1" class="sex" id="sex1">男<span style="display:none;">${member.sex }</span>
								  </label>
							  </div>
							  <div class="radio">
								  <label>
                          ...
                          <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="account" value="${member.account }" readonly>
                       		 <p class="help-block">Help text here.</p>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="money" value="${member.money }" readonly>
                       		 <p class="help-block">Help text here.</p>
                          </div>
