...
;(function(){
 ...
 function init(){
  ...
  if(circleNumber>0){
    ...
    for(var i=0;i<circleNumber;i++){
	    ...
	    mCircle.getElementsByTagName('a')[0].addEventListener('click',function(e){
	      ...
	      if(contentType=='images'){
	       ...
	       img.setAttribute('src',this.getAttribute("data-url"));
	       if(this.parentNode.getElementsByTagName('div')[0])
	        caption.innerHTML=this.parentNode.getElementsByTagName('div')[0].innerHTML;
	      }
    ...
    if(this.options.contentType=='images'){
     mainContent.getElementsByTagName('a')[0].setAttribute('href',circle.getElementsByTagName('div')[0].getElementsByTagName('a')[0].getAttribute('href'));
     mainContent.getElementsByTagName('img')[0].setAttribute('src',circle.getElementsByTagName('div')[0].getElementsByTagName('a')[0].getAttribute('data-url'));
   ...
   case 'rotateAround':
     ...
     for(var i=0;i<elem.options.circleNumber;i++){
       ...
       if(elem.options.contentType=='images'){
        elem.options.mainContent.getElementsByTagName('a')[0].setAttribute('href',div[topCircleNTH].getElementsByTagName('a')[0].getAttribute('href'));
        elem.options.mainContent.getElementsByTagName('img')[0].setAttribute('src',div[topCircleNTH].getElementsByTagName('a')[0].getAttribute('data-url'));
